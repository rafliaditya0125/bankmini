                                        ...
                                        <tr key={item.id} className="hover:bg-slate-50/70 transition-colors">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-center">
                                                <div className="flex items-center justify-center gap-1.5">
                                                    {/* View Detail Nasabah button */}
                                                    <Link
                                                        href={`/${rolePrefix}/kantong/${item.id}`}
                                                        className="inline-flex items-center gap-1 px-3 py-1.5 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 rounded-xl text-[10px] font-bold uppercase tracking-wider transition-colors"
                                                        title="Lihat Detail Saldo Nasabah"
                                                    >
